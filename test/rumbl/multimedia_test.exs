defmodule Rumbl.MultimediaTest do
    ...
    describe "videos" do
        ...
        @invalid_attrs %{descrption: nil, title: nil, url: nil}
        ...
        test "update_video/2 with valida data updates the video" do
            owner = user_fixture()
        ...
        test "update_video/2 with invalida data returns error changeset" do
            owner = user_fixture()

defmodule RumblWeb.VideoController do
  ...
  def show_a_category(conn, _params, _current_user) do
    videos_with_category = Multimedia.get_category_under_action_category()
    render(conn, "show_a_category.html", videos: videos_with_category)
  end
